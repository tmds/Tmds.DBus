// Generated by Tmds.DBus.Tool v0.23.1 with arguments: codegen --protocol-api --service-name Mpris ../MediaPlayer/org.mpris.MediaPlayer2.Player.xml ../MediaPlayer/org.mpris.MediaPlayer2.Playlists.xml ../MediaPlayer/org.mpris.MediaPlayer2.TrackList.xml ../MediaPlayer/org.mpris.MediaPlayer2.xml --output Mpris.DBus.cs
// <auto-generated/>
#nullable enable
namespace Mpris.DBus
{
    ...
    sealed partial class Player : Tmds.DBus.Protocol.DBusObject
    {
        public const string DBusInterfaceName = "org.mpris.MediaPlayer2.Player";
        public Player(Tmds.DBus.Protocol.DBusConnection connection, string destination, ObjectPath path)
        ...
        public ValueTask<IDisposable> WatchSeekedAsync(Action<Exception?, long> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => Connection.WatchSignalAsync(Destination, Path, DBusInterfaceName, "Seeked", (Message m, object? s) => MessageReader.Read_x(m), handler, this, emitOnCapturedContext, flags);
        ...
        public Task<string> GetPlaybackStatusAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("PlaybackStatus"), (Message m, object? s) => MessageReader.Read_v_s(m), this);
        public Task<string> GetLoopStatusAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("LoopStatus"), (Message m, object? s) => MessageReader.Read_v_s(m), this);
        public Task<double> GetRateAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Rate"), (Message m, object? s) => MessageReader.Read_v_d(m), this);
        public Task<bool> GetShuffleAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Shuffle"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<Dictionary<string, VariantValue>> GetMetadataAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Metadata"), (Message m, object? s) => MessageReader.Read_v_aesv(m), this);
        public Task<double> GetVolumeAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Volume"), (Message m, object? s) => MessageReader.Read_v_d(m), this);
        public Task<long> GetPositionAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Position"), (Message m, object? s) => MessageReader.Read_v_x(m), this);
        public Task<double> GetMinimumRateAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("MinimumRate"), (Message m, object? s) => MessageReader.Read_v_d(m), this);
        public Task<double> GetMaximumRateAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("MaximumRate"), (Message m, object? s) => MessageReader.Read_v_d(m), this);
        public Task<bool> GetCanGoNextAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanGoNext"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanGoPreviousAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanGoPrevious"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanPlayAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanPlay"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanPauseAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanPause"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanSeekAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanSeek"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanControlAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanControl"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
    ...
    sealed partial class Playlists : Tmds.DBus.Protocol.DBusObject
    {
        public const string DBusInterfaceName = "org.mpris.MediaPlayer2.Playlists";
        public Playlists(Tmds.DBus.Protocol.DBusConnection connection, string destination, ObjectPath path)
            : base(connection, destination, path)
        { }
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => MessageReader.Read_arossz(m), this);
            MessageBuffer CreateMessage()
            {
                var writer = Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchPlaylistChangedAsync(Action<Exception?, (ObjectPath, string, string)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => Connection.WatchSignalAsync(Destination, Path, DBusInterfaceName, "PlaylistChanged", (Message m, object? s) => MessageReader.Read_rossz(m), handler, this, emitOnCapturedContext, flags);
        public Task<uint> GetPlaylistCountAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("PlaylistCount"), (Message m, object? s) => MessageReader.Read_v_u(m), this);
        public Task<string[]> GetOrderingsAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Orderings"), (Message m, object? s) => MessageReader.Read_v_as(m), this);
        public Task<(bool, (ObjectPath, string, string))> GetActivePlaylistAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("ActivePlaylist"), (Message m, object? s) => MessageReader.Read_v_rbrosszz(m), this);
    ...
    sealed partial class TrackList : Tmds.DBus.Protocol.DBusObject
    {
        public const string DBusInterfaceName = "org.mpris.MediaPlayer2.TrackList";
        public TrackList(Tmds.DBus.Protocol.DBusConnection connection, string destination, ObjectPath path)
            : base(connection, destination, path)
        { }
        public Task<Dictionary<string, VariantValue>[]> GetTracksMetadataAsync(ObjectPath[] trackIds)
        {
            return Connection.CallMethodAsync(CreateMessage(), (Message m, object? s) => MessageReader.Read_aaesv(m), this);
            MessageBuffer CreateMessage()
            {
                var writer = Connection.GetMessageWriter();
                writer.WriteMethodCallHeader(
        ...
        public ValueTask<IDisposable> WatchTrackListReplacedAsync(Action<Exception?, (ObjectPath[] Tracks, ObjectPath CurrentTrack)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => Connection.WatchSignalAsync(Destination, Path, DBusInterfaceName, "TrackListReplaced", (Message m, object? s) => MessageReader.Read_aoo(m), handler, this, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackAddedAsync(Action<Exception?, (Dictionary<string, VariantValue> Metadata, ObjectPath AfterTrack)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => Connection.WatchSignalAsync(Destination, Path, DBusInterfaceName, "TrackAdded", (Message m, object? s) => MessageReader.Read_aesvo(m), handler, this, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackRemovedAsync(Action<Exception?, ObjectPath> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => Connection.WatchSignalAsync(Destination, Path, DBusInterfaceName, "TrackRemoved", (Message m, object? s) => MessageReader.Read_o(m), handler, this, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackMetadataChangedAsync(Action<Exception?, (ObjectPath TrackId, Dictionary<string, VariantValue> Metadata)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => Connection.WatchSignalAsync(Destination, Path, DBusInterfaceName, "TrackMetadataChanged", (Message m, object? s) => MessageReader.Read_oaesv(m), handler, this, emitOnCapturedContext, flags);
        public Task<ObjectPath[]> GetTracksAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Tracks"), (Message m, object? s) => MessageReader.Read_v_ao(m), this);
        public Task<bool> GetCanEditTracksAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanEditTracks"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
    ...
    sealed partial class MediaPlayer2 : Tmds.DBus.Protocol.DBusObject
    {
        public const string DBusInterfaceName = "org.mpris.MediaPlayer2";
        public MediaPlayer2(Tmds.DBus.Protocol.DBusConnection connection, string destination, ObjectPath path)
            : base(connection, destination, path)
        { }
        ...
        public Task<bool> GetCanQuitAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanQuit"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetFullscreenAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Fullscreen"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanSetFullscreenAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanSetFullscreen"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetCanRaiseAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("CanRaise"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<bool> GetHasTrackListAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("HasTrackList"), (Message m, object? s) => MessageReader.Read_v_b(m), this);
        public Task<string> GetIdentityAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("Identity"), (Message m, object? s) => MessageReader.Read_v_s(m), this);
        public Task<string> GetDesktopEntryAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("DesktopEntry"), (Message m, object? s) => MessageReader.Read_v_s(m), this);
        public Task<string[]> GetSupportedUriSchemesAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("SupportedUriSchemes"), (Message m, object? s) => MessageReader.Read_v_as(m), this);
        public Task<string[]> GetSupportedMimeTypesAsync()
            => Connection.CallMethodAsync(CreateGetPropertyMessage("SupportedMimeTypes"), (Message m, object? s) => MessageReader.Read_v_as(m), this);
