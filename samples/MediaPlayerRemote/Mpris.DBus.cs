// Generated by Tmds.DBus.Tool v0.23.1 with arguments: codegen --protocol-api --service-name Mpris ../MediaPlayer/org.mpris.MediaPlayer2.Player.xml ../MediaPlayer/org.mpris.MediaPlayer2.Playlists.xml ../MediaPlayer/org.mpris.MediaPlayer2.TrackList.xml ../MediaPlayer/org.mpris.MediaPlayer2.xml
// <auto-generated/>
#nullable enable
namespace Mpris.DBus
{
    ...
    partial class Player : MprisObject
    {
        ...
        public ValueTask<IDisposable> WatchSeekedAsync(Action<Exception?, long> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "Seeked", (Message m, object? s) => MessageReader.Read_x(m), handler, emitOnCapturedContext, flags);
    ...
    partial class Playlists : MprisObject
    {
        ...
        public ValueTask<IDisposable> WatchPlaylistChangedAsync(Action<Exception?, (ObjectPath, string, string)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "PlaylistChanged", (Message m, object? s) => MessageReader.Read_rossz(m), handler, emitOnCapturedContext, flags);
    ...
    partial class TrackList : MprisObject
    {
        ...
        public ValueTask<IDisposable> WatchTrackListReplacedAsync(Action<Exception?, (ObjectPath[] Tracks, ObjectPath CurrentTrack)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackListReplaced", (Message m, object? s) => MessageReader.Read_aoo(m), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackAddedAsync(Action<Exception?, (Dictionary<string, VariantValue> Metadata, ObjectPath AfterTrack)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackAdded", (Message m, object? s) => MessageReader.Read_aesvo(m), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackRemovedAsync(Action<Exception?, ObjectPath> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackRemoved", (Message m, object? s) => MessageReader.Read_o(m), handler, emitOnCapturedContext, flags);
        public ValueTask<IDisposable> WatchTrackMetadataChangedAsync(Action<Exception?, (ObjectPath TrackId, Dictionary<string, VariantValue> Metadata)> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
            => base.WatchSignalAsync(Service.Destination, __Interface, Path, "TrackMetadataChanged", (Message m, object? s) => MessageReader.Read_oaesv(m), handler, emitOnCapturedContext, flags);
